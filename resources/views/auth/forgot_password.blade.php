...
<body class="bg-slate-100 poppins-regular ">
    ...
    <div class="w-full h-screen md:px-4 md:py-2 flex items-center justify-center">
        <div
            class="w-full md:max-w-xl h-full md:h-auto  p-4 bg-white rounded-lg shadow-2xl shadow-slate-900 sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 relative overflow-hidden flex flex-col justify-center items-center">
